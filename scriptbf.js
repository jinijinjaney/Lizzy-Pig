...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (hour >= 5 && hour < 12) {
        greetingText = "Good morning, baby";
    } else if (hour >= 12 && hour < 18) {
        greetingText = "Good afternoon, baby";
    } else {
        greetingText = "Good evening, baby";
    }

    greetingElement.innerHTML = `${greetingText} <img src="images/steve.gif" alt="Cute Bee GIF" class="steve-gif">`;
});